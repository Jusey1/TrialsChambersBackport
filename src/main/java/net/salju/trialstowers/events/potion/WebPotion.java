...
public class WebPotion implements IBrewingRecipe {
	@Override
	...
	public boolean isIngredient(ItemStack ingredient) {
		return ingredient.getItem() == Items.COBWEB;
	}

	@Override
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionUtils.setPotion(new ItemStack(input.getItem()), TrialsPotions.WEAVE.get());
		}
